...
const CompletedSessionShowAlert = ({ data, showCompleteModalInfoHandale }) => {
        ...
        <div className="flex-fill vstack gap-2">
          ...
          <div className="d-flex flex-sm-row flex-column gap-2 justify-content-between mt-auto">
            <div className="d-flex flex-sm-row flex-column gap-2">
              <span>{t("NotificationsTab.ConfirmationAlertSubTitle")}</span>
              <span>
                <ShowImage
            ...
            <div
              ...
              onClick={() => showCompleteModalInfoHandale(data)}
            >
...
export default CompletedSessionShowAlert;
